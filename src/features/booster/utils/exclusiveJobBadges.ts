...
// vinculado normal ainda mostra o tempo restante da janela de 9h. Pedido
...
// janela de 9h o backend (accept_boost_order) para de tratar como
...
// usa a mesma janela de 9h (accept_boost_order trata os dois com a mesma
