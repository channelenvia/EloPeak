  ...
  return (
    <div className="h-screen overflow-hidden flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Mobile bottom nav */}
        <nav className="md:hidden border-t border-border-subtle bg-bg-surface/90 backdrop-blur-xl flex shrink-0">
          ...
          {/* Notificações -- antes só o mobile nav do admin tinha isso;
              cliente/booster não tinham nenhuma forma de ver notificações no
              celular (a sino só existe dentro do rail expandido, que não
              expande em telas sem hover). */}
