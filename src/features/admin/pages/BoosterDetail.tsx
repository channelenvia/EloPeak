...
import { formatDate, formatRank, formatLastSeen, safeOpggUrl } from '@/lib/utils'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <Card padding="md">
          <h3 className="text-base font-semibold text-ink mb-3">Dados Pessoais / PIX</h3>
          <div className="space-y-2 text-sm">
            {[
      ...
      {/* Performance */}
      <Card padding="md">
        <h3 className="text-base font-semibold text-ink mb-3">Desempenho</h3>
      ...
      <Card padding="md">
        <h3 className="text-base font-semibold text-ink mb-1">Estatísticas por Faixa de Elo</h3>
        ...
        {!hasStats ? (
          ...
          <div className="space-y-3">
            {(Object.keys(BRACKET_LABEL) as RankBucket[]).map((bracket) => {
              ...
              return (
                <div key={bracket} className="flex items-center justify-between py-2 border-b border-border-subtle last:border-0">
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-6 text-right">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-brand">{Math.round((stats.wins / stats.total_matches) * 100)}%</p>
                    </div>
                  </div>
                </div>
              )
