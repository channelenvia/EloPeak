  ...
  return (
    <div className="py-16 relative overflow-hidden">
      <SEOHead
        ...
        description="Elo Boost, Win Boost, MD5, Clash e Coaching para League of Legends. Escolha o serviço ideal pro seu objetivo de rank."
      />
      <div className="absolute inset-0 bg-hero-glow pointer-events-none" />
      <div className="container-wide space-y-20 relative">
        {/* Header */}
        <ScrollReveal className="text-center max-w-2xl xl:max-w-none mx-auto">
