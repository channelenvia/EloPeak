    ...
    Functions: {
      ...
      apply_order_drop: {
        Args: {
          ...
          p_order_id: string
          p_reason: string
          p_requested_by_role?: Database["public"]["Enums"]["drop_requester_role"]
        }
        Returns: Json
      }
      approve_booster: {
      ...
      calc_elo_price_cents: {
        Args: {
          p_boost_mode: string
          p_from_division: string
          p_from_tier: string
          p_queue_type: string
          p_to_division: string
          p_to_tier: string
        }
        Returns: number
      }
      can_booster_accept_order: {
        Args: {
          p_boost_mode: string
          p_booster_user_id: string
          p_service_type?: string
        }
        Returns: Json
      }
      cancel_order_after_drop_limit: {
        Args: {
          p_actor_id: string
          p_from_status: string
          p_order_id: string
      ...
      get_order_chat_mention_targets: {
        Args: { p_order_id: string }
        Returns: Json
      }
      get_order_credentials: { Args: { p_order_id: string }; Returns: Json }
      get_order_customer_nickname: {
        Args: { p_order_id: string }
        Returns: string
      }
      get_order_duo_account_history: {
        Args: { p_order_id: string }
        Returns: Json
      }
      get_order_duo_partner_riot_id: {
        Args: { p_order_id: string }
        Returns: string
      }
