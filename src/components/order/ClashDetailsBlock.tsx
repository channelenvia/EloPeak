  ...
  return (
    <div className="flex items-center gap-3 min-w-0 shrink-0">
      ...
      <div className="min-w-0">
        <p className="text-[11px] text-ink-muted uppercase tracking-wide">Tier de Clash</p>
...
export function ClashDayBadge({ createdAt, clashDay }: { createdAt: string; clashDay: ClashDay | null }) {
  ...
  return (
    <div className="flex items-center gap-3 min-w-0 shrink-0">
      <div className="flex items-center justify-center bg-bg-elevated border border-bg-overlay shrink-0 w-20 h-20 rounded-2xl p-2">
        <span className="text-lg font-extrabold text-ink leading-none" data-tabular>{day}/{month}</span>
      </div>
      <div className="min-w-0">
        <p className="text-[11px] text-ink-muted uppercase tracking-wide">Dia do Clash</p>
